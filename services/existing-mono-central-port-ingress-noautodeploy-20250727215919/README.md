# existing-mono-central-port-ingress-noautodeploy-20250727215919
...
```
docker build -t existing-mono-central-port-ingress-noautodeploy-20250727215919:latest .
docker run -p:5030:8080 existing-mono-central-port-ingress-noautodeploy-20250727215919:latest
```
